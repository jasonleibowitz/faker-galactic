...
- uv.lock update
- Add Typing::Typed classifier and fix README links [#7](https://github.com/jasonleibowitz/faker-galactic/pull/7)
...
### Added
- Initial release with Star Trek, Star Wars, Battlestar Galactica, and Stargate providers
- Character names, ship names, planet names, and quotes for each universe
